...
procedure TForm2.cxRadioButton1Click(Sender: TObject); //жирный текст
begin
...
procedure TForm2.cxRadioButton2Click(Sender: TObject); //курсивный текст
begin
...
procedure TForm2.cxRadioButton3Click(Sender: TObject); //подчеркнутый текст
begin
...
procedure TForm2.cxRadioButton4Click(Sender: TObject); //зачеркнутый текст
begin
