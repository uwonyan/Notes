...
procedure TForm3.cxRadioButton1Click(Sender: TObject); //жирный текст
begin
...
procedure TForm3.cxRadioButton2Click(Sender: TObject); //курсивный текст
begin
...
procedure TForm3.cxRadioButton3Click(Sender: TObject); //подчеркнутый текст
begin
...
procedure TForm3.cxRadioButton4Click(Sender: TObject); //зачеркнутый текст
begin
...
begin
  b:= Unit1.Form1.ADOTable1.Fields.Fields[5].AsString;         //стиль
